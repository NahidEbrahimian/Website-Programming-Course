<html>
    ...
    <body style="background-color: #f1f2f6; font-family: Cursive;">
        <div style="width: 30%" class="container">
            <div class="mt-1 row">
                <form method="post" action="add-new-contact">
                    <div style="background-color: gray;" class="rounded-2 px-4 pb-4">
                        <input type="hidden" name="_token" value="{{ csrf_token()}}">
                        <div class="row text-center">
                            <h3 class="mt-3 text-white" >Add New Contact</h2>
                        </div>
                    ...
                    <div>
                        <button type="submit" class="btn btn-success text-white mt-2">Save Contact</button>
                    </div>
                </form>
            </div>
        </div>
