                        ...
                        <tbody>
                            ...
                            <tr class="text-center text-white">
                                ...
                                <td style="text-align: center;" >
                                    <button class="text-white" style="width: 100%; height: 40px; background-color: #f7c621; border: none; border-radius: 3px;" onclick='accept_request({{ $request->id }}, "{{ csrf_token() }}")'>
                                        قبول کردن درخواست
                                    </button>
                                </td>
                            </tr>
